  ...
  .defines(function() {
    ig.SoundHandler = ig.Class.extend({
        ...
        sfxSoundsToLoad: [{
            ...
            name: "ringSound",
            path: "media/audio/scary/ring"
        }, {
            name: "fallSound",
            path: "media/audio/scary/fall"
        }, {
            name: "cheerSound",
            path: "media/audio/scary/cheer"
        }, {
            name: "buttonSound",
            ...
            name: "countOneSound",
            path: "media/audio/scary/count-one"
        }, {
            name: "countTwoSound",
            path: "media/audio/scary/count-two"
        }, {
            name: "countThreeSound",
            path: "media/audio/scary/count-three"
        }, {
            name: "countFourSound",
            path: "media/audio/scary/count-four"
        }, {
            name: "countFiveSound",
            path: "media/audio/scary/count-five"
        }],
        debug: !1,
        init: function() {
            this.initSfx();
